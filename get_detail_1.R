...
#faa_data <- rbind(
#        readRDS("./faa_data_ck_2_bf_0201.rds"),
#        readRDS("./faa_data_ck_2_bf_0301.rds"),
#        readRDS("./faa_data_ck_2_bf_0401.rds")
#)
#        
#
...
print(faa_data %>% summarise(across(10:28, ~sum(is.na(.)))))

#Classification Send_Date Send_Date_EST Month   Day  Hour Minute Effective_String Eff_Start
#<int>     <int>         <int> <int> <int> <int>  <int>            <int>     <int>
# 46         0             0     0     0     0      0             1666      1666
...
#)
#
#faa_data <- faa_data %>% filter(Date<="02/01/25")
#print(dim(faa_data))
#
#faa_data <- faa_data %>% 
#  mutate(
...
#
#
#saveRDS(faa_data, "faa_data_ck_1_bf_0201.rds")