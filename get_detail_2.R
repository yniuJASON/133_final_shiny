...
faa_data <- readRDS("./faa_data_ck_1_bf_0301.rds") %>%
  process_advisories_safe()

saveRDS(faa_data, "faa_data_ck_2_bf_0301.rds")
...
#)
#
#faa_data <- faa_data %>% filter(Date>"02/01/25" & Date<="03/01/25")
#print(dim(faa_data))
#
#faa_data <- faa_data %>% 
#  mutate(
...
#  )
#
#saveRDS(faa_data, "faa_data_ck_1_bf_0301.rds")